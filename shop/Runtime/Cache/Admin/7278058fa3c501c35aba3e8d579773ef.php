...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="<?php echo U('Cate/index');?>" target="right"><span class="icon-caret-right"></span>分类管理</a></li>
    <li><a href="<?php echo U('Goods/index');?>" target="right"><span class="icon-caret-right"></span>商品管理</a></li>
    <li><a href="<?php echo U('Goods/recycle');?>" target="right"><span class="icon-caret-right"></span>回收站</a></li>  
...
<div class="admin"> 
  <iframe scrolling="auto" rameborder="0" src="<?php echo U('info');?>" name="right" width="100%" height="100%"></iframe>
</div>
</body>
</html>